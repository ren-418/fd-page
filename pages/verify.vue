<template>
  <div class="md:container mx-0 lg:mx-auto pt-5">
    <div class="grid grid-cols-1 md:grid-cols-2 p-0 gap-10 items-center lg:pl-10 lg:pr-32 w-full">
      ...
      <div
        class="w-full bg-none md:bg-white p-5 rounded-xl flex flex-col gap-10 md:shadow-xl card-height"
      >
        <h1 class="text-2xl">
        ...
        <div class="flex flex-col gap-3">
          <div
            v-if="isEmailUse"
            class="icon-prefix-input text-base email-input-wrapper resend"
          >
            <Icon name="email" />
            <input
            v-model="email"
          ...
          <div
            v-if="!isEmailUse"
            class="phone-number-input text-base email-input-wrapper resend w-100"
          >
            <PhoneNumber
        ...
        <div class="flex flex-col gap-3 p-5 border border-color-2 rounded-lg">
          ...
          <input
            class="border border-color-2 p-3 text-xl rounded-lg"
