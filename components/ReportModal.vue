<template>
  <div v-show="isVisible"
    ...
    <div class="flex flex-col max-w-[500px] bg-white rounded-md border-color-1 border-solid border relative z-10">
      <!-- Close Button -->
      <p class="text-[22px] text-black absolute top-4 right-4 z-1 cursor-pointer" @click="handleReportClick">
      ...
      <div class="flex flex-col gap-4 w-full p-4">
        <div class="flex flex-col w-full gap-2">
          ...
          <input v-if="detail_data" type="text"
            ...
            :placeholder="detail_data.id" disabled="true" />
        </div>
